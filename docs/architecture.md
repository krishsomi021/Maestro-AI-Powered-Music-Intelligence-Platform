...
flowchart LR
    ...
    subgraph API["FastAPI (Producer)"]
        ...
        EP6["GET /stats/top-tracks"]
        EP7["GET /stats/top-artists"]
        EP8["GET /stats/listening-trends"]
    end
